...
public class GameFactory {
    ...
    public static Game createIndoorGame() {
    ...
    public static Game createIndoorGame(final SharedPreferences sharedPreferences) {
    ...
    public static Game createBeachGame() {
    ...
    public static Game createBeachGame(final SharedPreferences sharedPreferences) {
