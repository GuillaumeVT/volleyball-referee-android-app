...
public class WebUtils {
    ...
    private static String BASE_URL                 = BuildConfig.SERVER_ADDRESS;
    ...
    private static String GAME_CODE_URL            = BASE_URL + "/api/view/game/code/%d";
    private static String USER_GAME_URL            = BASE_URL + "/api/user/game";
    private static String USER_SCHEDULED_GAMES_URL = USER_GAME_URL + "/available";
    private static String USER_RULES_URL           = BASE_URL + "/api/user/rules";
    private static String USER_TEAM_URL            = BASE_URL + "/api/user/team";
