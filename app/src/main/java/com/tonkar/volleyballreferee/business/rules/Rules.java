...
public class Rules extends ApiRules {
    ...
    public static Rules officialIndoorRules() {
        return new Rules(DEFAULT_INDOOR_ID,
                Authentication.VBR_USER_ID, 0L, 0L, DEFAULT_INDOOR_NAME, GameType.INDOOR,
    ...
    public static Rules officialBeachRules() {
        return new Rules(DEFAULT_BEACH_ID,
                Authentication.VBR_USER_ID, 0L, 0L, DEFAULT_BEACH_NAME, GameType.BEACH,
    ...
    public static Rules defaultIndoor4x4Rules() {
        return new Rules(DEFAULT_INDOOR_4X4_ID,
                Authentication.VBR_USER_ID, 0L, 0L, DEFAULT_INDOOR_4X4_NAME, GameType.INDOOR_4X4,
                5, 25, true, 15, true, true, true, 2, 30,
                true, 60, true, 180,
    ...
    public static ApiRulesDescription getDefaultRules(GameType kind) {
        final Rules rules;
        ...
        ApiRulesDescription rulesDescription = new ApiRulesDescription();
